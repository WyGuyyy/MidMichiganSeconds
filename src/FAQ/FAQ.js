            ...
            <div className="faqContainer">
                ...
                <section className="FAQ-Content-Section" style={{height: this.state.middleSectionHeight}}>
                    <div className="FAQ-Content-Header">
                        <div className="FAQ-Content-Header-Image" style={{background: backgroundImage}}> 
                    ...
                    <div className="FAQ-Content-Wrapper">
                        <div className="FAQ-Content-Displayed FAQ-Content">
                        ...
                        <div className="FAQ-Content-Price FAQ-Content">
                        ...
                        <div className="FAQ-Content-Upload FAQ-Content">
                        ...
                        <div className="FAQ-Content-Change FAQ-Content">
                        ...
                        <div className="FAQ-Content-Available FAQ-Content">
                        ...
                        <div className="FAQ-Content-MoreThanOnce FAQ-Content">
                        ...
                        <div className="FAQ-Content-URL FAQ-Content">
